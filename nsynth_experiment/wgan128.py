...
params_discriminator['stride'] = [1, 2, 2, 2, 1, 1]
params_discriminator['nfilter'] = [16, 64, 256, 256, 256, 32]
params_discriminator['shape'] = [[13], [11], [9], [9], [9], [5]]
...
params_generator['stride'] = [1, 2, 2, 2, 1 , 1]
params_generator['latent_dim'] = 100
params_generator['nfilter'] = [16, 64, 256, 256, 32, 1]
params_generator['shape'] = [[5], [7], [9], [9], [11], [13] ]
params_generator['batch_norm'] = [bn, bn, bn, bn, bn]
params_generator['full'] = [100, 16*16]
