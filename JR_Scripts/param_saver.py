...
def main():
    ...
    params['name'] = 'TWGAN_TS2_gp50_andres_transform_09b1'
    params['model_idx'] = 2
    ...
    params['optimization']['disc_learning_rate'] = 8e-5
    params['optimization']['gen_learning_rate'] = 8e-5
    params['optimization']['beta1'] = 0.8
