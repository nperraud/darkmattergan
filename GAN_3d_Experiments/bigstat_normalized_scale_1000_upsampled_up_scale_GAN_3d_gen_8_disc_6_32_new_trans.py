...
if __name__ == "__main__":
	...
	name = 'bigstat_normalized_scale_1000_upsampled_upscaling_GAN_3d_{}'.format(ns)

	forward = functools.partial(data.fmap.normalize, scale=1000)
	backward = functools.partial(data.fmap.un_normalize, scale=1000)
