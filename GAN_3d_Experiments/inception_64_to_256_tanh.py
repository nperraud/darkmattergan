...
if __name__ == "__main__":
	...
	time_str = 'upscaling_GAN_3d_gen_8_disc_6_32_tanh' 
	...
	params_cosmology['forward_map'] = data.fmap.tanh_forward
	params_cosmology['backward_map'] = data.fmap.tanh_backward
