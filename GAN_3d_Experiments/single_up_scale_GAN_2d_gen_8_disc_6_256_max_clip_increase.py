...
import os
import data, utils
from model import upscale_WGAN_single_model
...
if __name__ == "__main__":
	...
	time_str = 'single_upscaling_GAN_2d_gen_8_disc_6_256_max_clip_increase' 
	...
	wgan = CosmoGAN(params, upscale_WGAN_single_model, is_3d=False)
	dataset = data.load.load_dataset(spix=ns, resolution=256,Mpch=Mpch, forward_map=forward, patch=False)
