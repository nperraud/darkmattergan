...
if __name__ == "__main__":
	...
	forward = functools.partial(data.fmap.log_norm_forward, c=8000.0, shift=8.987322)
	backward = functools.partial(data.fmap.log_norm_backward, c=8000.0, shift=8.987322)


	time_str = '32_32_32_log_norm_c_8k' 
