...
def backward(y, k=10., scale=1., real_max=1e8):
    ''' Inverse of the function forward map
        
    Numpy version
    '''

    simple_max = forward(real_max, k, scale)
    simple_min = forward(0, k, scale)
...
if __name__ == "__main__":
	...
	time_str = 'upscaling_GAN_2d_gen_8_disc_6_k_10' 
